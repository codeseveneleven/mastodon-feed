...
window.addEventListener("load", () => {
    const mastodonTimeline = new MastodonApi({
        ...
        instance_url: document.querySelector('.mt-timeline').dataset.instanceurl,

        // Choose type of toots to show in the timeline: 'local', 'profile', 'hashtag'. Default: local
        timeline_type: document.querySelector('.mt-timeline').dataset.timelinetype,

        // Your user ID on Mastodon instance. Leave empty if you didn't choose 'profile' as type of timeline
        user_id: document.querySelector('.mt-timeline').dataset.userid,

        // Your user name on Mastodon instance. Leave empty if you didn't choose 'profile' as type of timeline
        profile_name: document.querySelector('.mt-timeline').dataset.profilename,

        // The name of the hashtag. Leave empty if you didn't choose 'hashtag' as type of timeline
        hashtag_name: document.querySelector('.mt-timeline').dataset.hashtagname,

        // Maximum amount of toots to get. Default: 20
        toots_limit: document.querySelector('.mt-timeline').dataset.tootslimit,
