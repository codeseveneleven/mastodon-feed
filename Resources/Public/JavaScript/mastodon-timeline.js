...
window.addEventListener("load", () => {
  ...
  const timelineElements = document.querySelectorAll('.mt-body[role="feed"]');
  ...
  for (timelineElement of timelineElements) {
    (function() {
      ...
      const mastodonTimeline = new MastodonApi({
        ...
        container_body_id: timelineElement.id,

        // Class name for the loading spinner (also used in CSS file)
        spinner_class: "loading-spinner",

        // Preferred color theme: 'light', 'dark' or 'auto'. Default: auto
        default_theme: elementDataSet.instanceurl || "auto",

        // Your Mastodon instance
        instance_url: elementDataSet.instanceurl,

        // Choose type of toots to show in the timeline: 'local', 'profile', 'hashtag'. Default: local
        timeline_type: elementDataSet.timelinetype,

        // Your user ID on Mastodon instance. Leave empty if you didn't choose 'profile' as type of timeline
        user_id: elementDataSet.timelinetype==='profile' ? elementDataSet.userid : '',

        // Your user name on Mastodon instance. Leave empty if you didn't choose 'profile' as type of timeline
        profile_name: elementDataSet.timelinetype==='profile' ? elementDataSet.profilename : '',

        // The name of the hashtag. Leave empty if you didn't choose 'hashtag' as type of timeline
        hashtag_name: elementDataSet.timelinetype==='hashtag' ? elementDataSet.hashtagname : '',

        // Maximum amount of toots to get. Default: 20
        toots_limit: elementDataSet.limit || "20",

        // Hide unlisted toots. Default: don't hide
        hide_unlisted: parseInt(elementDataSet.hideunlisted) || false,

        // Hide boosted toots. Default: don't hide
        hide_reblog: parseInt(elementDataSet.hidereblog) ||  false,

        // Hide replies toots. Default: don't hide
        hide_replies: parseInt(elementDataSet.hidereplies) || false,

        // Hide preview card if toot contains a link, photo or video from a URL. Default: don't hide
        hide_preview_link: parseInt(elementDataSet.hidepreviewlink) || false,

        // Hide custom emojis available on the server. Default: don't hide
        hide_emojos: parseInt(elementDataSet.hideemojos) || false,

        // Converts Markdown symbol ">" at the beginning of a paragraph into a blockquote HTML tag. Ddefault: don't apply
        markdown_blockquote: parseInt(elementDataSet.markdownblockquote) || false,

        // Limit the text content to a maximum number of lines. Default: 0 (unlimited)
        text_max_lines: elementDataSet.textmaxlines || "0",

        // Customize the text of the link pointing to the Mastodon page (appears after the last toot)
        link_see_more: elementDataSet.linkseemore || "See more posts at Mastodon",
      });
